...
import org.amp4j.internet.Deferred;
import org.amp4j.internet.Reactor;
import org.amp4j.internet.Protocol;
import org.amp4j.internet.IProtocol;
import org.amp4j.internet.ITransport;
...
public class AMP extends AMPParser {
    ...
    public void ampBoxReceived(AMPBox box) {
        ...
        if ("_answer".equals(msgtype)) {
            ...
            // UNHANDLED
            /*
            AMPBox errBox = new AMPBox();
            errBox.put("_error", box.get("_ask"));
            errBox.put("_error_code", "UNHANDLED");
            errBox.put("_error_description", String.format("Unhandled Command: '%s'", cmdprop));
            this.sendBox(errBox);
            */
        }
    }
